...
import FormikProductEdit from "./ProductFormikUpdate";
...
export default function ProductSaga() {
  ...
  return (
    <div>
      {displayEdit ? (
        <FormikProductEdit setRefresh={setRefresh} setDisplay={setDisplayEdit} id={id} />
      ) : display ? (
        <FormikProductCreate setRefresh={setRefresh} setDisplay={setDisplay} />
      ) : (
        <div>
          <Layout>
            <>
              <div className="container max-w-7xl mx-auto mt-8">
                <div className="mb-4">
                  <h1 className="font-serif text-3xl font-bold underline decoration-gray-400">Product List</h1>
                      ...
                      <table className="min-w-full">
                        <thead>
                          <tr>
                            ...
                            <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Price</th>
                        ...
                        {product &&
                          ...
                          product.map((product: any) => {
                            return (
                              <tbody className="bg-white" key={product.productId}>
                                <tr>
                                  <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div className="flex items-center">{product.productId}</div>
                                  </td>
                                  ...
                                  <td className="d-flex">
                                    <td className="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                      <button className="text-indigo-600 hover:text-indigo-900" onClick={() => onClick(product.productId)}>
