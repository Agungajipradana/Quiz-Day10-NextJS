...
import { DelProductCategoryRequest, GetProductCategoryRequest } from "../../redux-saga/action/productCategoryAction";
import FormikProductCategoryEdit from "./ProductCategoryFormikUpdate";
import FormikProductCategoryCreate from "./ProductCategoryFormikCreate";
          ...
          <Layout>
            <>
              <div className="container max-w-7xl mx-auto mt-8">
                <div className="mb-4">
                  <h1 className="font-serif text-3xl font-bold underline decoration-gray-400">Product Category List</h1>
                  ...
                  <div className="overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                    <div className="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                      <table className="min-w-full">
                        <thead>
                          <tr>
                            <th className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Product Category ID</th>
                        ...
                        {productCategory &&
                          ...
                          productCategory.map((productCategory: any) => {
                            return (
                              <tbody className="bg-white" key={productCategory.productCategoryId}>
                                <tr>
                                  <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div className="flex items-center">{productCategory.productCategoryId}</div>
                                  </td>

                                  <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div className="text-sm leading-5 text-gray-900">{productCategory.name}</div>
                                  </td>
                                  ...
                                  <td className="d-flex">
                                    <td className="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                      <button className="text-indigo-600 hover:text-indigo-900" onClick={() => onClick(productCategory.productCategoryId)}>
                                    ...
                                    <td className="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                      <button onClick={() => onDelete(productCategory.productCategoryId)}>
