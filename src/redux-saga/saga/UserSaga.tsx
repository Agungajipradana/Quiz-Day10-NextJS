...
import { UserSigninFailed, UserSigninSuccess, UserSignoutFailed, UserSignoutSuccess, UserSignupFailed, UserSignupRequest } from "../action/userAction";
...
function* handleSignup(action: any): any {
  ...
  try {
    ...
    yield put(UserSignupRequest(result.data));
  } catch (error) {
